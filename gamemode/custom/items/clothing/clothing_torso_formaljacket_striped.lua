...
ITEM.Description 		= "A formal striped jacket for high-ranking officials."
	...
	function ITEM:GetModelData(ply)
		return {
			torso = {
				...
				Materials = {
					["models/tnb/citizens/suit_white"] = "models/tnb/citizens/suit_blackstripe",
					["models/tnb/citizens/femsuit_white"] = "models/tnb/citizens/femsuit_blackstripe",
			}
			}
		}
	end
