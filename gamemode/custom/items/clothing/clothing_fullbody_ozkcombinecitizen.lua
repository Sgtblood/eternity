...
ITEM.Name 				= "OZK-Citizen Hazmat"
ITEM.Description 		= "A OZK Hazmat suit, commonly used by the Soviet's, usually given to civil workers or departments."
...
if SERVER then
    ...
    function ITEM:PostModelData(ply, old)
            return { 
                _base = {
                    Model = Model("models/purgatory/soviet/zashita/ozk_pm.mdl"),
                    Skin = 0
                }
        }
    end
