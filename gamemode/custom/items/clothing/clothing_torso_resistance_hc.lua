...
ITEM.Name 				= "High-Tech Command Resistance Gear"
ITEM.Description 		= "Retooled gear for leaders of the resistance."
...
if SERVER then
	function ITEM:GetModelData(ply)
		...
		local model = "models/tnb/halflife2/rebels/%s_torso_resistance9.mdl"
