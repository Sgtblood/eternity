...
ITEM.Name 				= "Infestation Control Volunteer Suit"
ITEM.Description 		= "A green suit meant to protect you from your toxic friends."

ITEM.Model 				= Model("models/tnb/halflife2/citizens/items/item_hazmat.mdl")
ITEM.Material           = "models/hlvr/characters/hazmat_worker/hazmat_worker_green"
    ...
    function ITEM:GetModelData(ply)
		...
		return {
            torso = {
                ...
                Materials = {
                    ["models/hlvr/characters/hazmat_worker/hazmat_worker_3"] = "models/hlvr/characters/hazmat_worker/hazmat_worker_green"
            }
            }
        }
	end
