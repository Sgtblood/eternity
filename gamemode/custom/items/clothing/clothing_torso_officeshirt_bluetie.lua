...
ITEM.Description 		= "Pressed and wrinkless office shirt. Comes with a blue tie."
	...
	function ITEM:GetModelData(ply)
		return {
			torso = {
				...
				Materials = {
					["models/mist/textures/secshirt_d"] = "models/mist/textures/secshirt_d_white_bluetie",
			}
			}
		}
	end
