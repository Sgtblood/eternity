...
function PANEL:Init()
	...
	self.List.OnRowSelected = function(pnl, index, row)
        ...
        if self.SelectedUnit:SpeciesState() == "police_divisional" or self.SelectedUnit:SpeciesState() == "police_squadleader" then
            self.EditGrade:SetDisabled(true)
            self.EditSquad:SetDisabled(false)
            self.PromoteClass:SetDisabled(true)
            self.DemoteClass:SetDisabled(true)

            if (LocalPlayer():HasCombinePermission(COMBINE_ADMINS_PROMOTE_SQL) and self.SelectedUnit:SpeciesState() == "police_squadleader") or LocalPlayer():SpeciesState() == "police_captain" then
                self.DemoteClass:SetDisabled(false)
            end 

            if self.SelectedUnit:SpeciesState() == "police_squadleader" and LocalPlayer():SpeciesState() == "police_captain" then
                self.PromoteClass:SetDisabled(true)
            end
        ...
        elseif self.SelectedUnit:SpeciesState() == "police_eliteunit" then
            self.EditGrade:SetDisabled(false)
            self.EditSquad:SetDisabled(false)
            self.DemoteClass:SetDisabled(false)
            self.PromoteClass:SetDisabled(true)
