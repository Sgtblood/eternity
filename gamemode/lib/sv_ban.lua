hook.Add("OnDBALConnected", "ban.OnDBALConnected", function(key)
	...
	dbal.RegisterTable("connor4_Blob", "bans", "bans", {
...
function Get(steamid, active, global)
	...
	local res = dbal.Query("connor4_Blob", query .. table.concat(where, " AND "), unpack(args))
	local tab = {}
