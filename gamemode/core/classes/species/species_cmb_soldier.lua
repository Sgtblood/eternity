...
CLASS.PlayerModels 			= {
	Model("models/tnb/halflife2/combine/combine_grunt_hlvr_player.mdl")
}
...
CLASS.SpeciesStates = {
	...
	["soldier_bcmd"] = {
		...
		CombineLevel = COMBINE_LEVEL_UPPERASSET,
		VisibleRPName = function(ply, scoreboard)
			return string.format("COTA.C107-BCMD.%s", ply:VisibleCitizenNumber())
		end,
		ForceTeam = TEAM_OVERWATCH,
		DisallowTeamItems = true,
		UseTeamSpawn = true,
	...
	["soldier_bgcmd"] = {
		...
		CombineLevel = COMBINE_LEVEL_UPPERASSET,
		VisibleRPName = function(ply, scoreboard)
			return string.format("COTA.BGCMD-%s", ply:VisibleCitizenNumber())
		end,
		ForceTeam = TEAM_OVERWATCH,
		DisallowTeamItems = true,
		UseTeamSpawn = true,
