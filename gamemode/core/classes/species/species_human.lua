...
CLASS.SpeciesStates = {
	...
	["eventcharacter"] = {
		ForceTeam = TEAM_EVENTCHAR,
		DisallowTeamItems = true,
		CombinePermissions = {[COMBINE_RATION_STANDARD] = false},
		CombineLevel = COMBINE_LEVEL_CITIZEN
	},
	...
	["infcon_intern"] = {
		...
		Flagged = {
			...
			VisibleRPName = function(ply, scoreboard) return string.format("CIC.C34-INTERN.%s", ply:CombineSquad()) end,
	...
	["infcon_normal"] = {
		...
		Flagged = {
			...
			FlaggingZone = "ent_zone_infconstaging",
			VisibleRPName = function(ply, scoreboard) return string.format("CIC.C34-%s", ply:CombineSquad()) end,
			ForceTeam = TEAM_INFCON,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
		}
	...
	["infcon_teamleader"] = {
		...
		Flagged = {
			...
			FlaggingZone = "ent_zone_infconstaging",
			VisibleRPName = function(ply, scoreboard) return string.format("CIC.C34-TL.%s", ply:CombineSquad()) end,
			ForceTeam = TEAM_INFCON,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
		}
	...
	["infcon_supervisor"] = {
		...
		Flagged = {
			...
			FlaggingZone = "ent_zone_infconstaging",
			VisibleRPName = function(ply, scoreboard) return string.format("CIC.C34-SVR.%s", ply:CombineSquad()) end,
			ForceTeam = TEAM_INFCON,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
		}
	...
	["engineer_normal"] = {
		...
		Flagged = {
			...
			VisibleRPName = function(ply, scoreboard) return string.format("CEC.C34-%s", ply:CombineSquad()) end,
	...
	["engineer_foreman"] = {
		...
		Flagged = {
			...
			FlaggingZone = "ent_zone_cecwarehouse",
			VisibleRPName = function(ply, scoreboard) return string.format("CEC.C34-CF.%s", ply:CombineSquad()) end,
			ForceTeam = TEAM_ENGINEERS,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
		}
	...
	["engineer_seniorforeman"] = {
		...
		Flagged = {
			...
			FlaggingZone = "ent_zone_cecwarehouse",
			VisibleRPName = function(ply, scoreboard) return string.format("CEC.C107-ChF.%s", ply:CombineSquad()) end,
			ForceTeam = TEAM_ENGINEERS,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
		}
	...
	["police_recruit"] = { 
		...
		Flagged = {
			...
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-Rct.%s", ply:VisibleCitizenNumber()) end,
	...
	["police_unit"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_LOWERASSET,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-%s.%02i.%s", ply:CombineSquad(), ply:CombineRank(), ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_eliteunit"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_LOWERASSET,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-%s.01i.%s", ply:CombineSquad(), ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_intel"] = {
		...
		Flagged = {
			...
			VisibleRPName = function(ply, scoreboard) 
				return string.format("CCA.C34-OWL.%s", ply:VisibleCitizenNumber())
			end,	
		}
	},
	...
	["police_squadleader"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_LOWERADMIN,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-%s.SqL.%s", ply:CombineSquad(), ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_divisional"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_LOWERADMIN,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-%s.DvL.%s", ply:CombineSquad(), ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_captain"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_UPPERADMIN,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-CmD.%s", ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_commissioner"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_UPPERADMIN,
			VisibleRPName = function(ply, scoreboard) return string.format("CCA.C34-COM.%s", ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
	...
	["police_sector"] = { 
		...
		Flagged = {
			...
			CombineLevel = COMBINE_LEVEL_UPPERADMIN,
			VisibleRPName = function(ply, scoreboard) return string.format("UU.EU-SeC.%s", ply:VisibleCitizenNumber()) end,
			ForceTeam = TEAM_POLICE,
			DisallowTeamItems = true,
			UseTeamSpawn = true,
			AnnounceFlagging = true
...
CLASS.Gestures = {
	...
	},
	{
		...
		Options = {
			["Hands Up"] = "handsup",
			["Hands Cuffed"] = "Handscuffed",
			["Hands Pocketed"] = "Handspocket",
			["Arms Crossed"] = "g_Pacer_ArmsCrossedloopArms",
			["Arrest Wall 1"] = "wallarrest1",
			["Arrest Wall 2"] = "wallarrest2",
			["Arrest Floor"] = "floorarrest1",
			["Injured 1"] = "injured1",
			["Injured 2"] = "injured3",
			["Lying Down 1"] = "Lying_Down",
			["Lying Down 2"] = "lyingdown2",
			["Lean Back 1"] = "lean_back",
			["Lean Back 2"] = "plazaidle1",
			["Lean Left 1"] = "lean_left",
			["Lean Left 2"] = "plazaidle3",
			["Sit Chair 1"] = "silo_sit",
			["Sit Chair 2"] = "sit_chair",
			["Sit Chair 3"] = "Trainstation_Int",
			["Sit Ground"] = "Sit_Ground",
		}
	},
	{
		Group = "Rifle Poses",
		HoldAnimation = true,
		Options = {
			["Rifle Down"] = "rifleholddown",
			["Rifle Up"] = "rifleholdup",
			["Rifle Shoulder"] = "rifleshoulder",
		}
	}
}
...
function CLASS:GetVoicelines(ply)
	local itm = ply:GetEquipment(EQUIPMENT_HEAD)
	
	if itm and string.find(itm:GetClassName(), "head_metropolice") then
...
if CLIENT then
	...
	function CLASS:GetModelData(ply)
		if ply:SpeciesState() == "eventchar" then
			return {
				_base = {
					Model = ply:CharModel(),
					Skin = ply:CharSkin(),
