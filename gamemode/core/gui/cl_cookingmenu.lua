...
function PANEL:Init()
    ...
    self.Recipes.OnRowSelected = function(pnl, index, row)
        ...
        local item = right:Add("eternity_cookingpanel")
...
vgui.Register("eternity_cookingmenu", PANEL, "eternity_basepanel")

GM:RegisterGUI("CookingMenu", function(type)
    local pnl = vgui.Create("eternity_cookingmenu")
