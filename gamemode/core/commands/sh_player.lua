...
console.AddClientCommand("rp_whatisthis", function(ply)
	local ent = ply:GetEyeTrace().Entity

	if ent and PERMAPROP_CLASSES[ent:GetClass()] then
		print(ent.AttachedEntity and ent.AttachedEntity:GetModel() or ent:GetModel())
	end
end, COMMAND_ALL, {}, {},
"Clientside", "Identifies the path of the current model the player is looking at.")
...
console.AddCommand("rp_togglechat", function(ply)
	ply:SetSetting("chat_enabled", not ply:GetSetting("chat_enabled"))
end, COMMAND_ALL, {}, {},
"Clientside", "Toggles your chat on or off.")
...
console.AddClientCommand("rp_stopeffect", function(ply)
...
"Clientside", "Stops any currently playing effect sounds or URLs")
