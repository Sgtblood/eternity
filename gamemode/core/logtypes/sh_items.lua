...
GM:RegisterLogType("item_lootable", LOG_ITEMS, function(data)
	return string.format("%s has looted %s from an entity", GAMEMODE:FormatCharacter(data.Char), GAMEMODE:FormatItem(data.Item))
end)