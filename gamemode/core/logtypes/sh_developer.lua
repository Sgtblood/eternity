...
GM:RegisterLogType("command_cleanupitems", LOG_DEVELOPER, function(data)
	return string.format("%s cleared item entities from the worldspace: %s", GAMEMODE:FormatPlayer(data.Ply), data.Str)
end)
