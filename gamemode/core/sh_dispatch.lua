...
GM.DispatchVoicelines = {
	...
	[22] = { "npc/overwatch/cityvoice/fprison_interfacebypass.wav", "Warning. Malignant Viral Interface bypass detected. Polyphasic core reprogramming detected. Sterilizers and containment fields may be compromised." },
}
