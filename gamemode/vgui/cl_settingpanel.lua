...
function PANEL:Setup(key, odd)
	...
	elseif setting.Type == TYPE_NUMBER then
		local slider = self.Right:Add("DNumSlider")

		slider:SetMin(setting.Data.Min or 0)
		slider:SetMax(setting.Data.Max or 1)
		slider:SetValue(GAMEMODE:GetSetting(key))
		slider:SetPos(-168, (self.Right:GetTall() * 0.5) - (slider:GetTall() * 0.5))
		slider:SetWide(400)
