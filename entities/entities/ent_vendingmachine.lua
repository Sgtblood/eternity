...
ENT.Model 			= Model("models/willardnetworks/misc/customvendingmachine.mdl")
...
if SERVER then
	function ENT:Use(ply)
		...
		if not ply:HasMoney(10) then
			ply:SendChat("ERROR", "The vending machine requires 2 credits.")
		...
		ply:TakeMoney(10)
		ply:SendChat("NOTICE", "You insert 2 credits into the vending machine.")
