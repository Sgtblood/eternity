...
SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_rifle_bayonet_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_rifle_bayonet_wm.mdl")
