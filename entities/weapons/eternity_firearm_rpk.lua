...
SWEP.ViewModel 			= Model("models/weapons/c_ins2_rpk_74m.mdl")

SWEP.WorldModel 		= Model("models/weapons/w_ins2_rpk_74m.mdl")
...
SWEP.FireSound 			= Sound("weapons/tfa_ins2/project_immursion/rpk/rpk_fp.wav")
