...
SWEP.ViewModel 			= Model("models/weapons/v_gsh18_request.mdl")


SWEP.WorldModel 		= Model("models/weapons/w_gsh18.mdl")
...
SWEP.FireSound 			= Sound("weapons/tfa_ins2/project_immursion/m45/m45_fp.wav")
