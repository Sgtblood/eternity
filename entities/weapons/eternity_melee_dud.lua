...
SWEP.PrintName 			= "The Dud"
SWEP.Author 			= "Mickee"

SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_rpgdud_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_rpgdud_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_rpgdud_idle",
	draw = "h1_wpn_melee_rpgdud_pullout",
	hit = {"h1_wpn_melee_rpgdud_swipe"},
	miss = {"h1_wpn_melee_rpgdud_swipe"}
}
