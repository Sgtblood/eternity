...
SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_katana_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_katana_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_katana_idle",
	draw = "h1_wpn_melee_katana_pullout_first",
	hit = {"h1_wpn_melee_katana_swipe"},
	miss = {"h1_wpn_melee_katana_swipe"}
}
