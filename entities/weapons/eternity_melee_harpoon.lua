...
SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_harpoon_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_harpoon_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_harpoon_idle",
	draw = "h1_wpn_melee_harpoon_pullout",
	hit = {"h1_wpn_melee_harpoon_stab"},
	miss = {"h1_wpn_melee_harpoon_stab"}
}
