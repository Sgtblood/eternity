...
SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_sickle_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_sickle_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_sickle_idle",
	draw = "h1_wpn_melee_sickle_pullout",
	hit = {"h1_wpn_melee_sickle_swipe"},
	miss = {"h1_wpn_melee_sickle_swipe"}
}
