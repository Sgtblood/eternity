...
SWEP.PrintName 			= "Knuckle Knife"
SWEP.Author 			= "Mickee"

SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_knuckle_knife_irish_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_knuckle_knife_irish_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_knuckle_knife_idle",
	draw = "h1_wpn_melee_knuckle_knife_pullout",
	hit = {"h1_wpn_melee_knuckle_knife_swipe"},
	miss = {"h1_wpn_melee_knuckle_knife_swipe"}
}
