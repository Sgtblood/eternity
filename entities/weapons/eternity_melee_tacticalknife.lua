...
SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_tactical_knife_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_tactical_knife_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_bayonet_knife_idle",
	draw = "h1_wpn_melee_bayonet_knife_pullout",
	hit = {"h1_wpn_melee_bayonet_knife_swipe"},
	miss = {"h1_wpn_melee_bayonet_knife_swipe"}
}
