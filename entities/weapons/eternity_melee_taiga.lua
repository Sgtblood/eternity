...
SWEP.PrintName 			= "Taiga Machete"
SWEP.Author 			= "Mickee"

SWEP.ViewModel 			= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_russian_machete_vm.mdl")

SWEP.WorldModel 		= Model("models/weapons/tfa_cod/mwr/wpn_h1_melee_russian_machete_wm.mdl")
...
SWEP.Animations = {
	idle = "h1_wpn_melee_machete_idle",
	draw = "h1_wpn_melee_machete_pullout",
	hit = {"h1_wpn_melee_machete_swipe"},
	miss = {"h1_wpn_melee_machete_swipe"}
}
